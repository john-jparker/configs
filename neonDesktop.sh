...
#  Run on Linux (KDE NEON) https://neon.kde.org/download
...
echo "${GREEN} Snap installing GO aws-cli google-cloud-cli${NC}"
...
echo "${GREEN} apt install nodejs docker ffmpeg build-essential openjdk-17-jdk openjdk-17-jre python3-pip python3-virtualenv${NC}"
sudo apt-get install nodejs docker.io neovim ffmpeg build-essential openjdk-17-jdk openjdk-17-jre python3-pip python3-virtualenv rustc cargo -y
