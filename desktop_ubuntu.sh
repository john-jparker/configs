...
#Snap install GO, Node, aws-cli, google-cloud-cli, blender, discord, krita, postman, obs, inkscape, VScode, terraform, remmina 
    sudo apt install git ffmpeg mysql-client-core-8.0 openjdk-17-jdk openjdk-17-jre kdenlive -y
...
#Clean up and Restart
    rm HuionTablet_v15.0.0.89.202205241352.x86_64.deb amdgpu-install_5.4.50401-1_all.deb amdgpu-install_5.4.50401-1_all.deb 
    init 6
